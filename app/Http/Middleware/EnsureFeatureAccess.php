...
class EnsureFeatureAccess
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (in_array($routeName, ['home', 'dashboard', 'profile', 'logout', 'media.show', 'admin.terminal', 'pos.tabs.open', 'pos.tabs.close', 'pos.tabs.close-all', 'sales.orders.windows.open', 'sales.orders.windows.close'], true)) {
            return $next($request);
        }
