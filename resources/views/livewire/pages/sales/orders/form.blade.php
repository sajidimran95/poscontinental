...
new #[Layout('layouts.app'), Title('New Sales Order')] class extends Component
{
    ...
    public function updatedBrowseSearch(): void
    {
        ...
        // Browse popup should ONLY search/filter, NEVER auto-add
        // User must manually click item or press + button to add
        // Removed: if ($this->autoAddBrowseIfExactMatch()) { return; }
